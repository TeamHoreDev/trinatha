...
class Download extends CI_Controller
{
    ...
    public function penerimaan($tgl_awal, $tgl_akhir, $tangki)
    {
        $data['tgl_awal'] = $tgl_awal;
        $data['tgl_akhir'] = $tgl_akhir;
        $data['tangki'] = $tangki;
        $data['result'] = $this->laporan_m->get_penerimaan($tgl_awal, $tgl_akhir, $tangki);
        $this->load->view('pdf/penerimaan', $data);
    }
    public function pemakaian($tgl_awal, $tgl_akhir, $tangki)
    {
        $data['tgl_awal'] = $tgl_awal;
        $data['tgl_akhir'] = $tgl_akhir;
        $data['tangki'] = $tangki;
        $data['result'] = $this->laporan_m->get_pemakaian($tgl_awal, $tgl_akhir, $tangki);
