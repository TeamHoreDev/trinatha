...
<body class="hold-transition login-page" style="background-image: url(<?= base_url() . 'assets/images/bg-trinatha.jpeg' ?>); background-repeat: no-repeat;
