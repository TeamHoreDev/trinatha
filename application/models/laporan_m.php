...
class laporan_m extends CI_Model
{
    ...
    public function get_penerimaan($tgl_awal, $tgl_akhir, $tangki)
    {
        $this->db->select('*');
    ...
    public function get_pemakaian($tgl_awal, $tgl_akhir, $tangki)
    {
        $this->db->select('*');
        $this->db->from($this->_table);
    ...
    public function get_total($tgl_awal, $tgl_akhir, $alat)
    {
        $this->db->select_sum('solar_out');
        $this->db->from($this->_table);
        $this->db->join('pengambilan', 'pengambilan.kode_transaksi = solar.kode_transaksi', 'left');
